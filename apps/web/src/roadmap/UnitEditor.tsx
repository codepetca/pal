...
import type { RoadmapData, Unit, RoadmapNode, NodeType, NodeStatus } from "./types";
...
export function UnitEditor({ data, onSave, onClose, activeTrackIndex }: UnitEditorProps) {
  ...
  // ponytail: deliberate any — heterogeneous editor form bag (string/number/
  // NodeType/NodeStatus fields). Typing each would thread casts through ~10
  // assignment sites in this ported editor. Not worth it here.
