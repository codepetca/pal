...
const HOME_CHAPTER_ROWS: readonly ChapterRow[] = [
  ...
  ["try-again", 2, "core", "Undeterred", "Frustrated but undeterred, you begin again. This time, you use the measuring cup and work carefully. Soon, the aroma of freshly baked bread fills the house, and one warm, soft bun rests on the table.", "fresh-bread-v1", "Fresh Bread", "/assets/world/reward-fresh-bread-v1.png", "cosmetic", ["undeterred", "Undeterred", "You kept going after a difficult first try.", "Trying again changed what came next."]],
  ...
  ["by-stream", 4, "core", "Job done", "The new path soon becomes familiar beneath your feet. You follow it often to picnic by the stream, carrying warm bread and cookies in your basket. Pip and Lumi enjoy every visit. You feel content and quietly proud of what the three of you built together.", "stream-picnic-v1", "Stream Picnic", "/assets/world/reward-picnic-basket-v2.png", "cosmetic", ["pathmaker", "Pathmaker", "You helped build a path worth returning to.", "A patient path became part of home."]],
  ["epilogue", 4, "core", "Epilogue", "Twilight settles over the courtyard. You watch your dear friends disappear into the house and remember when this place was empty. You turn your lantern toward your home for one last look. Its light catches something pale within a small pile of twigs above the window.", "new-egg-v1", "New Egg", "/assets/world/reward-new-egg-v1.png", "cosmetic", ["homekeeper", "Homekeeper", "You made an empty place feel like home.", "Care, patience, and friendship made this place a home."]],
];
...
const homeChapters = chaptersFromRows(HOME_CHAPTER_ROWS, "cosmetic");
