...
const HOME_CHAPTER_ROWS: readonly ChapterRow[] = [
  ["new-start", 1, "core", "A New Adventure", "You enter a dark, unfamiliar place with your trusty lantern. Warm light spreads, and it begins to feel full of possibility.", "home-warming-lantern-v1", "Trusty Lantern", "/assets/world/reward-home-warming-lantern-v1.png"],
