CREATE TABLE "achievement_instances" (
	...
	CONSTRAINT "achievement_instances_id_learner_uq" UNIQUE("id","learner_id"),
...
CREATE TABLE "learner_facts" (
	...
	CONSTRAINT "learner_facts_id_learner_uq" UNIQUE("id","learner_id")
);
--> statement-breakpoint
...
ALTER TABLE "weekly_rhythm_configs" ADD CONSTRAINT "weekly_rhythm_configs_period_owner_fk" FOREIGN KEY ("learner_id","period_key") REFERENCES "public"."achievement_periods"("learner_id","period_key") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
