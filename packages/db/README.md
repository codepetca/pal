...
rewards, events, and state, but a cascade alone is not a verified erasure operation.
...
contract, locking requirements, and retained-copy limits](../../docs/profile-erasure-contract.md).
