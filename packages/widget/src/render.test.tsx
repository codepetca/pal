...
test("each week has a collectible slot that reveals only earned rewards", () => {
  ...
  assert.match(html, /aria-label="Current title: Rhythm Builder"/);
...
test("a story reward includes a title award without opening a title-only celebration", () => {
  ...
  assert.match(celebration, /New title/);
  assert.match(celebration, /Gentle Keeper/);
